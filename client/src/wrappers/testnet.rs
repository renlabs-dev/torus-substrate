...
pub async fn get_permission0_accumulated_stream_amounts_by_account_id32_1_by_h256_2_by_h256_3(
    client: &OnlineClient<PolkadotConfig>,
    account_id32_1: ::subxt::ext::subxt_core::utils::AccountId32,
    h256_2: ::subxt::ext::subxt_core::utils::H256,
    ...
    let storage = client.storage().at_latest().await?;
    let result = storage
        .fetch(&api::storage().permission0().accumulated_stream_amounts(
            account_id32_1,
            h256_2,
            h256_3,
        ))
...
pub async fn query_all_permission0_accumulated_stream_amounts(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    Vec<(
        (
...
/// Get storage double map value by keys
pub async fn get_permission0_enforcement_tracking_by_h256_by_enforcement_referendum(
    client: &OnlineClient<PolkadotConfig>,
    h256_1: ::subxt::ext::subxt_core::utils::H256,
    enforcement_referendum_2: runtime_types::pallet_permission0::permission::EnforcementReferendum,
) -> Result<
    Option<
        runtime_types::bounded_collections::bounded_btree_set::BoundedBTreeSet<
            ::subxt::ext::subxt_core::utils::AccountId32,
...
> {
    ...
    let result = storage
        .fetch(
            &api::storage()
                .permission0()
                .enforcement_tracking(h256_1, enforcement_referendum_2),
        )
        .await?;
    Ok(result)
}
/// Query all entries in storage double map
pub async fn query_all_permission0_enforcement_tracking(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    HashMap<
        ::subxt::ext::subxt_core::utils::H256,
...
> {
    ...
    let mut result = HashMap::new();
    let mut iter = storage
        .iter(api::storage().permission0().enforcement_tracking_iter())
        .await?;
    while let Some(Ok(kv)) = iter.next().await {
        if let Ok((key1, key2)) = <(
            ::subxt::ext::subxt_core::utils::H256,
...
/// Get storage map value by key
pub async fn get_permission0_permissions_by_h256(
    client: &OnlineClient<PolkadotConfig>,
...
> {
    let storage = client.storage().at_latest().await?;
    let result = storage
        .fetch(&api::storage().permission0().permissions(h256))
        .await?;
    Ok(result)
}
/// Query all entries in storage map
pub async fn query_all_permission0_permissions(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    HashMap<
        ::subxt::ext::subxt_core::utils::H256,
...
> {
    ...
    let mut result = HashMap::new();
    let mut iter = storage
        .iter(api::storage().permission0().permissions_iter())
        .await?;
    while let Some(Ok(kv)) = iter.next().await {
...
/// Get storage map value by key
pub async fn get_permission0_permissions_by_grantee_by_account_id32(
    client: &OnlineClient<PolkadotConfig>,
    account_id32: ::subxt::ext::subxt_core::utils::AccountId32,
) -> Result<
    Option<
...
> {
    ...
    let result = storage
        .fetch(
            &api::storage()
                .permission0()
                .permissions_by_grantee(account_id32),
        )
        .await?;
    Ok(result)
}
/// Query all entries in storage map
pub async fn query_all_permission0_permissions_by_grantee(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    HashMap<
        String,
...
> {
    ...
    let mut result = HashMap::new();
    let mut iter = storage
        .iter(api::storage().permission0().permissions_by_grantee_iter())
        .await?;
    while let Some(Ok(kv)) = iter.next().await {
        if let Ok(key) =
            ::subxt::ext::subxt_core::utils::AccountId32::decode(&mut &kv.key_bytes[32..])
...
/// Get storage map value by key
pub async fn get_permission0_permissions_by_grantor_by_account_id32(
    client: &OnlineClient<PolkadotConfig>,
    account_id32: ::subxt::ext::subxt_core::utils::AccountId32,
) -> Result<
    Option<
...
> {
    ...
    let result = storage
        .fetch(
            &api::storage()
                .permission0()
                .permissions_by_grantor(account_id32),
        )
        .await?;
    Ok(result)
}
/// Query all entries in storage map
pub async fn query_all_permission0_permissions_by_grantor(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    HashMap<
        String,
...
> {
    ...
    let mut result = HashMap::new();
    let mut iter = storage
        .iter(api::storage().permission0().permissions_by_grantor_iter())
        .await?;
    while let Some(Ok(kv)) = iter.next().await {
        if let Ok(key) =
            ::subxt::ext::subxt_core::utils::AccountId32::decode(&mut &kv.key_bytes[32..])
...
/// Get storage double map value by keys
pub async fn get_permission0_permissions_by_participants_by_account_id32_by_account_id32(
    client: &OnlineClient<PolkadotConfig>,
    account_id32_1: ::subxt::ext::subxt_core::utils::AccountId32,
...
> {
    ...
    let result = storage
        .fetch(
            &api::storage()
                .permission0()
                .permissions_by_participants(account_id32_1, account_id32_2),
        )
        .await?;
    Ok(result)
}
/// Query all entries in storage double map
pub async fn query_all_permission0_permissions_by_participants(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    HashMap<
        String,
...
/// Get storage map value by key
pub async fn get_permission0_revocation_tracking_by_h256(
    client: &OnlineClient<PolkadotConfig>,
    h256: ::subxt::ext::subxt_core::utils::H256,
) -> Result<
    Option<
...
> {
    let storage = client.storage().at_latest().await?;
    let result = storage
        .fetch(&api::storage().permission0().revocation_tracking(h256))
        .await?;
    Ok(result)
}
/// Query all entries in storage map
pub async fn query_all_permission0_revocation_tracking(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<
    HashMap<
        ::subxt::ext::subxt_core::utils::H256,
...
> {
    ...
    let mut result = HashMap::new();
    let mut iter = storage
        .iter(api::storage().permission0().revocation_tracking_iter())
        .await?;
    while let Some(Ok(kv)) = iter.next().await {
        if let Ok(key) = ::subxt::ext::subxt_core::utils::H256::decode(&mut &kv.key_bytes[32..]) {
            result.insert(key, kv.value);
...
/// Get storage value
pub async fn get_torus0_agent_update_cooldown(
    client: &OnlineClient<PolkadotConfig>,
) -> Result<Option<::core::primitive::u64>, Box<dyn std::error::Error>> {
    let storage = client.storage().at_latest().await?;
    let result = storage
        .fetch(&api::storage().torus0().agent_update_cooldown())
        .await?;
    Ok(result)
}
/// Get storage map value by key
