...
pub trait WeightInfo {
	...
	fn toggle_namespace_creation() -> Weight;
}
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn accept_application() -> Weight {
		...
		Weight::from_parts(77_000_000, 11000)
	...
	/// Storage: `Permission0::PermissionsByGrantor` (r:1 w:1)
	/// Proof: `Permission0::PermissionsByGrantor` (`max_values`: None, `max_size`: Some(3234), added: 5709, mode: `MaxEncodedLen`)
	/// Storage: `Governance::NamespaceCreationAllowed` (r:1 w:1)
	/// Proof: `Governance::NamespaceCreationAllowed` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	fn toggle_namespace_creation() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `48`
		//  Estimated: `11000`
